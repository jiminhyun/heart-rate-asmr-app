...
public class FocusAdapter extends RecyclerView.Adapter<FocusAdapter.CustomViewHolder> {
    ...
    public FocusAdapter(ArrayList<Focus> arrayList, Context context) {
