...
public class MeditateAdapter extends RecyclerView.Adapter<MeditateAdapter.CustomViewHolder> {
    ...
    public MeditateAdapter(ArrayList<Meditate> arrayList, Context context) {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            if(check2.equals(true)) {
                                if(snapshot.hasChild(cf)) {
                                    ...
                                    CustomToast.showToast(context, "즐겨찾기에 추가되었습니다.");
                                }
                                check2 = false;
                            }
                        }
