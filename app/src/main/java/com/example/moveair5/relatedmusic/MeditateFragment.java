...
public class MeditateFragment extends Fragment {
    ...
    private ArrayList<Meditate> arrayList;
    int checkint = 1;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        music = view.findViewById(R.id.meditating_music);
        previous = view.findViewById(R.id.meditating_previous);
        next = view.findViewById(R.id.meditating_next);
        songname = view.findViewById(R.id.meditatingnameView);
        linearLayout = view.findViewById(R.id.meditatingbar);

        recyclerView = view.findViewById(R.id.meditatingview);
        recyclerView.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        arrayList = new ArrayList<>();
        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("song/genre/meditate");
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                arrayList.clear();
                for(DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    Meditate meditate = dataSnapshot.getValue(Meditate.class);
        ...
        adapter = new MeditateAdapter(arrayList, getContext());
        adapter.setOnItemClickListener(new MeditateAdapter.OnItemClickListener() {
            @Override
        ...
        requireActivity().getOnBackPressedDispatcher().addCallback(new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                NavHostFragment.findNavController(MeditateFragment.this).popBackStack(R.id.nav_loginafter, false);
            }
        });
